...
export const catalog = [
  ...
  { id:'Aster',enabled:true,address:true,notice:'Публичный адрес кошелька Aster. Баланс и fills читаются через официальный Chain RPC; API Secret и приватный ключ не нужны.' },
